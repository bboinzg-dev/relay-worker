...
exports.DocumentUnderstandingServiceClient = void 0;
/* global window */
 ...
 */
const gapicConfig = require("./document_understanding_service_client_config.json");
...
class DocumentUnderstandingServiceClient {
    ...
    constructor(opts) {
        ...
        const batchProcessDocumentsResponse = protoFilesRoot.lookup('.google.cloud.documentai.v1beta1.BatchProcessDocumentsResponse');
        const batchProcessDocumentsMetadata = protoFilesRoot.lookup('.google.cloud.documentai.v1beta1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.documentai.v1beta1.DocumentUnderstandingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.documentUnderstandingServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.documentai.v1beta1.DocumentUnderstandingService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.documentai.v1beta1
                    .DocumentUnderstandingService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of documentUnderstandingServiceStubMethods) {
            const callPromise = this.documentUnderstandingServiceStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.DocumentUnderstandingServiceClient = DocumentUnderstandingServiceClient;
//# sourceMappingURL=document_understanding_service_client.js.map