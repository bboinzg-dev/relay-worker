...
async function aiCanonicalizeKeys(family, keys, knownKeys) {
...
`;
  ...
  for (const k of keys) {
    ...
    let action = (rec.action === 'map' && knownKeys.includes(canonical)) ? 'map' : 'new';
...
module.exports = { aiCanonicalizeKeys };