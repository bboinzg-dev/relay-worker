...
class DocumentUnderstandingServiceClient {
    ...
    constructor(opts) {
        ...
        const batchProcessDocumentsResponse = protoFilesRoot.lookup('.google.cloud.documentai.v1beta2.BatchProcessDocumentsResponse');
        const batchProcessDocumentsMetadata = protoFilesRoot.lookup('.google.cloud.documentai.v1beta2.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.documentai.v1beta2.DocumentUnderstandingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.documentUnderstandingServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.documentai.v1beta2.DocumentUnderstandingService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.documentai.v1beta2
